...
int mz_screen_init(void)
{
  ...
  xTaskCreatePinnedToCore(update_scrn_thread, "update_scrn_thread", 8192, NULL, 1, NULL, 0);
  ...
  while (1) {
    if (needScreenUpdateFlag == true && screnUpdateValidFlag == true) {
      ...
      */
      ...
      //if (ldcMode == 0) {
      //  //fb.pushSprite(0, 0);
     //   //fb.pushRotateZoomWithAA(120, 110, 0, 0.75, 0.9);
     //   fb.pushRotateZoomWithAA(120, 85, 0, 0.675, 0.675);
     // }
      //fb.pushSprite(&exLcd, 0, 0);
